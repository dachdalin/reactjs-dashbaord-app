...
function postTypeColor(type: PostResponse["type"]): string {
  ...
  return m[type] ?? "from-indigo-500 to-purple-600";
}
    ...
    <div className="space-y-8">
        ...
        <div>
          {loading ? (
            ...
            <div className="rounded-2xl bg-white/5 border border-white/10 p-6">
              <p className="text-gray-400 text-sm text-center">No post data available</p>
            </div>
          )}
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="rounded-2xl bg-linear-to-br from-indigo-600/50 to-purple-600/50 backdrop-blur-xl border border-white/10 p-6">
          ...
          <a href="/blogs" className="mt-4 inline-block px-4 py-2 bg-white text-indigo-600 rounded-lg font-medium hover:bg-gray-100 transition-colors">
            New Post
          </a>
        </div>
        <div className="rounded-2xl bg-white/5 backdrop-blur-xl border border-white/10 p-6">

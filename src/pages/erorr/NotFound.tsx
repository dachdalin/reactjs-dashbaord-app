  ...
  return (
    <div className="flex flex-col items-center justify-center h-full min-h-[70vh] text-center px-4">
      ...
      <div className="flex flex-col sm:flex-row items-center gap-4">
        <Link
          to="/dashboard"
          className="inline-flex items-center gap-2 px-6 py-3 rounded-xl font-medium text-white bg-white text-black hover:bg-white/90 shadow-lg shadow-black/25 transition-all duration-300 hover:shadow-black/40 hover:scale-105"
        >
          <svg
            className="w-5 h-5"
            fill="none"
        ...
        <button
          ...
          className="inline-flex items-center gap-2 px-6 py-3 rounded-xl font-medium text-white/80 bg-white/5 border border-white/10 hover:bg-white/10 hover:text-white transition-all duration-300"
        >
          <svg
            className="w-5 h-5"
            fill="none"
